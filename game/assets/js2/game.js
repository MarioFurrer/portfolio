...
function create (){
   ...
   this.anims.create({
    ...
    scoreText = this.add.text(320, 16, 'Score: 0', {
        fontSize: '45px', fill: '#8B00FF', fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif', fontStyle: 'oblique'
    });
